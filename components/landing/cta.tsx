        ...
        >
          ...
          <div className="relative px-8 py-16 md:px-16 md:py-24 text-center">
            ...
            <motion.h2
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary-foreground text-balance max-w-3xl mx-auto"
            >
              Ready to transform your tax training program?
            </motion.h2>
            ...
            >
              <Link href="/signup">
                <Button size="lg" variant="secondary" className="text-lg px-8 h-12 bg-primary-foreground text-primary hover:bg-primary-foreground/90">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="ghost" className="text-lg px-8 h-12 text-primary-foreground border-primary-foreground/30 hover:bg-primary-foreground/10">
                  Talk to Sales
                </Button>
              </Link>
            </motion.div>
