      ...
      <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold text-slate-950 dark:text-white">New course</h1>
            <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">
              Build a complete course structure with modules, lessons, and assignments.
            </p>
          </div>
